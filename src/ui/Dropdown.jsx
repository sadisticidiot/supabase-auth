...
export default function Dropdown(){
    ...
    return(
        <div className="border-1 border-white/20 absolute right-0 flex flex-col gap-1 p-2 bg-neutral-800 shadow-sm shadow-neutral-900 rounded-sm w-50">
            <div className="items-start flex flex-col pb-0 button-base bg-neutral-800 shadow-none inset-shadow-none hover:bg-neutral-700">
            ...
            <button
                className="button-base bg-neutral-800 shadow-none inset-shadow-none flex gap-2 hover:bg-neutral-700 p-1 py-2" 
